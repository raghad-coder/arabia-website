...
const About = () => {
  return (
    <section className="py-24 px-6 bg-enso-dark overflow-hidden">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-400 text-lg mb-8 leading-relaxed">
            Experience impressive events with enso Arabia, your all-in-one mega-experiences powerhouse. 
            Let us shape your future events with a 30+ years legacy and expert event organizer 
            and production Team.
          </p>
